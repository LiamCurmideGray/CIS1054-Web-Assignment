                ...
                <div class="collapsible-content">
                    <table>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><form action=\"?user=" . array_values($row)[0] . "\" method=\"post\">
                            <input type=\"submit\" class=\"deleteUserBtn\" name=\"deleteUser\" value=\"Delete\"></form></td>";
...
<?php
        ...
        if (isset($_POST['deleteUser'])) {
            ...
            // if (!empty($user_id)) {
                ...
                $sql = "DELETE FROM userroles WHERE UserId=$user_id;";
